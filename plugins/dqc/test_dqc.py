...
class MockExperiment: pass
class MockAgentSequences: pass
class MockSequence: pass
...
class TestDQCLogic(unittest.TestCase):
    ...
    def test_build_dynamic_experiment(self):
        ...
        commands_list = [
            ...
            {"timeslot": 1, "qpu_id": "LBNL-A", "command": "ENTG server_1_link_register[0], server_0_link_register[0]", "qpus_involved": ["LBNL-A", "LBNL-B"]},
            {"timeslot": 2, "qpu_id": "LBNL-A", "command": "CU1(1) server_0_link_register[1], server_0_link_register[0]", "qpus_involved": ["LBNL-A"]},
            {"timeslot": 3, "qpu_id": "LBNL-A", "command": "H server_1[0]", "qpus_involved": ["LBNL-A"]},
            {"timeslot": 0, "qpu_id": "LBNL-B", "command": "waiting", "qpus_involved": []},
            {"timeslot": 1, "qpu_id": "LBNL-B", "command": "ENTG server_1_link_register[0], server_0_link_register[0]", "qpus_involved": ["LBNL-A", "LBNL-B"]},
        ]
